...
function NuevoPassword() {
  ...
  const[tokenValido,setTokenValid]= useState(false);
  ...
  return (
    <>
        <div>
            <h1 className="text-indigo-600 font-black text-6xl">Restablece tus password y no pierdas tus <span className="text-black">Pacientes</span></h1>
        </div>
